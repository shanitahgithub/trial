...
Revision ID: 13b46b242e3e
Revises: c610c06b3fdd
Create Date: 2024-06-29 12:51:10.646554
...
revision = '13b46b242e3e'
down_revision = 'c610c06b3fdd'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('tick', sa.String(length=100), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['order_id'], ['orders.id'], ),
    sa.ForeignKeyConstraint(['restaurant_id'], ['restaurant.id'], ),
