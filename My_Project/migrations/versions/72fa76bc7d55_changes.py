...
Revision ID: 72fa76bc7d55
Revises: afc1219b4bcd
Create Date: 2024-07-07 00:43:01.231967
...
revision = '72fa76bc7d55'
down_revision = 'afc1219b4bcd'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    with op.batch_alter_table('order_item', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('order_item_ibfk_1', 'items', ['item_id'], ['id'])
